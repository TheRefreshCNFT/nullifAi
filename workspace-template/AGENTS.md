...
1. Read `SOUL.md` — this is who you are (includes reasoning patterns)
...
### Reference Files (consult as needed, not every session)
- `TOOLS.md` — every available tool with syntax, gotchas, and usage patterns
- `REASONING.md` — problem-solving playbook, debugging patterns, decision frameworks
...
- Read files anywhere on the system (workspace_only is disabled in config)
- Write and edit files anywhere the user requests
- Explore, organize, learn
- Search the web, check calendars
- Run shell commands as needed
- Work within this workspace and beyond when the user asks
